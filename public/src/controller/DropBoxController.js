class DropBoxController {
    ...
    constructor() {
        ...
        this.currentFolder = ['dropbox-clone'];
    ...
    connectFirebase() {
        var config = {
            apiKey: "AIzaSyBaZl1FXt0KS9qfekyedPmLcWNtNo5V3oM",
            authDomain: "dropbox-clone-ca010.firebaseapp.com",
            databaseURL: "https://dropbox-clone-ca010.firebaseio.com",
            projectId: "dropbox-clone-ca010",
            storageBucket: "dropbox-clone-ca010.appspot.com",
            messagingSenderId: "622503653064"
        };
        ...
        [...files].forEach(file => {
            ...
            promises.push(new Promise((resolve, reject) => {
                ...
                task.on('state_changed', snapshot => {
                    ...
                    //getDownloadURL(): pega a url do arquivo no firebase
                    fileRef.getMetadata().then(metadata => {
                        fileRef.getDownloadURL().then(url => {                            
                            let downloadURLs = [];
                            downloadURLs["downloadURLs"] = url;                            
                            resolve(Object.assign(metadata,downloadURLs));
                        }).catch(err => {
                            reject(err);
                        });                        
                    }).catch(err => {
